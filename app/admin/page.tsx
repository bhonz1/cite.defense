              ...
              <div className="overflow-x-auto">
                <Table>
                  <TableHeader className="bg-gray-50/80">
                    <TableRow className="hover:bg-gray-100/80">
                      <TableHead className="font-semibold text-gray-700">Research Title</TableHead>
                      <TableHead className="font-semibold text-gray-700">Team Members</TableHead>
                      <TableHead className="font-semibold text-gray-700">Type</TableHead>
                      <TableHead className="font-semibold text-gray-700">Date & Time</TableHead>
                      <TableHead className="font-semibold text-gray-700">Room</TableHead>
                      <TableHead className="font-semibold text-gray-700">Panelists</TableHead>
                  ...
                  <TableBody>
                    {filteredAppointments.length === 0 ? (
                      ...
                      filteredAppointments.map((appointment, index) => (
                        <TableRow 
                          key={appointment.id} 
                          className="hover:bg-gradient-to-r hover:from-orange-50/50 hover:to-red-50/50 transition-all duration-200 border-b border-gray-100 last:border-0"
                        >
                          <TableCell className="py-4">
                            <div className="space-y-1">
                              <div className="font-semibold text-gray-900 text-sm">{appointment.research_title}</div>
                              <div className="flex items-center gap-2">
                                <span className="text-xs text-gray-500">{appointment.acad_year}</span>
                                <span className="text-xs bg-gradient-to-r from-orange-100 to-red-100 text-orange-700 px-2 py-0.5 rounded-full font-medium">
                            ...
                            <div className="space-y-2">
                              {appointment.students?.map((student, idx) => (
                                <div key={idx} className="bg-gray-50 rounded-lg p-2 border border-gray-100">
                                  ...
                                  <div className="text-xs text-gray-500 mt-0.5">{student.student_id} - {student.course_section}</div>
                                  <Badge variant="outline" className="text-xs mt-1.5 bg-blue-50 text-blue-700 border-blue-200">
                                    {student.role}
                                  </Badge>
                                </div>
                              ))}
                          ...
                          <TableCell className="py-4">
                            <div className="space-y-1">
                              <div className="text-sm font-medium text-gray-900">{appointment.research_type}</div>
                          ...
                          <TableCell className="py-4">
                            <div className="flex items-center gap-2 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg px-3 py-2 border border-blue-100">
                              <MapPin className="h-4 w-4 text-blue-600" />
                              <span className="text-sm font-semibold text-blue-900">{appointment.room}</span>
                            </div>
                          </TableCell>
                          <TableCell className="py-4">
                            {appointment.status === "APPROVED" && appointment.group_code && appointmentsPanelists[appointment.group_code] ? (
                              <div className="space-y-1.5">
                                {appointmentsPanelists[appointment.group_code].map((panelist: any) => (
                                  <div key={panelist.id} className="flex items-center gap-2 bg-gray-50 rounded-lg px-2 py-1.5 border border-gray-100">
                                    <div className={`w-6 h-6 rounded-full flex items-center justify-center ${
                                      panelist.role === 'CHAIRMAN' ? 'bg-orange-100' : 'bg-blue-100'
                                    }`}>
                                    ...
                                    <div className="flex-1">
                                      <div className="font-medium text-gray-900 text-xs">{panelist.name}</div>
                          ...
                          <TableCell className="py-4">
                            <Badge className={`font-semibold px-3 py-1 ${getStatusColor(appointment.status)}`} variant="outline">
                              {appointment.status}
                            </Badge>
                          </TableCell>
                          <TableCell className="py-4">
                            <div className="flex gap-2 flex-wrap">
                              {appointment.status === "PENDING" && (
                                ...
                                <Dialog>
                                  <DialogTrigger>
                                    <div
                                      className="inline-flex items-center justify-center rounded-lg bg-gradient-to-r from-green-500 to-emerald-500 text-white px-4 py-2 text-sm font-semibold shadow-md hover:shadow-lg transition-all duration-200 hover:scale-105 cursor-pointer"
                                ...
                                <Button
                                  size="sm"
                                  variant="outline"
                                  className="text-red-600 border-red-200 hover:bg-red-50 hover:shadow-md transition-all"
                                  onClick={() => {
                              ...
                              <Dialog>
                                <DialogTrigger>
                                  <div
                                    className="inline-flex items-center justify-center rounded-lg bg-gradient-to-r from-orange-500 to-red-500 text-white px-4 py-2 text-sm font-semibold shadow-md hover:shadow-lg transition-all duration-200 hover:scale-105 cursor-pointer"
                                    onClick={() => setSelectedAppointment(appointment)}
                                  >
                              ...
                              <Button
                                size="sm"
                                variant="outline"
                                className="text-red-600 border-red-200 hover:bg-red-50 hover:shadow-md transition-all px-3 py-2"
                                onClick={() => {
